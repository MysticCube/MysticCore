...
public class FortuneConfig {
    public static String name = "Fortune";
    public static String color = "&e";

    // Info
    public static String guiItem = "PAPER";
    ...
    // Abilities
    public static double coinMultiplier = 10;
    ...
    public static void loadDefaultSettings(String enchantmentName){
        ...
        if(fortune == null){
            ...
            enchantment.set("CoinMultiplier", coinMultiplier);
        ...
        coinMultiplier = enchantment.getDouble("CoinMultiplier");
