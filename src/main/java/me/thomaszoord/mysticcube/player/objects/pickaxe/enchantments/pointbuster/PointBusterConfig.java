...
public class PointBusterConfig {
    public static String name = "Point Buster";
    ...
    // Abilities
    public static double pointMultiplier = 10;
    ...
    public static void loadDefaultSettings(String enchantmentName){
        ...
        if(fortune == null){
            ...
            enchantment.set("PointMultiplier", pointMultiplier);
        ...
        pointMultiplier = enchantment.getDouble("PointMultiplier");
