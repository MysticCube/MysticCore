...
public class TokenCollectorConfig {
    public static String name = "Token Collector";
    public static String color = "&e";

    // Info
    public static String guiItem = "IRON_BOOTS";
    ...
    // Abilities
    public static double tokenMultiplier = 10;
    ...
    public static void loadDefaultSettings(String enchantmentName){
        ...
        if(fortune == null){
            ...
            // Aplicando tradução diretamente ao array de descrição
            ...
            enchantment.set("CoinMultiplier", tokenMultiplier);
        ...
        tokenMultiplier = enchantment.getDouble("TokenMultiplier");
