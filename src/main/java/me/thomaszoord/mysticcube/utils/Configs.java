...
public class Configs {
    public static YAMLConfig core = new YAMLConfig(new File(Core.getPlugin().getDataFolder(), "locations.yml"));
    public static YAMLConfig config = new YAMLConfig(new File(Core.getPlugin().getDataFolder(), "config.yml"));
